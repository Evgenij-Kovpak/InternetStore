...
namespace MyOnlineStore.Areas.Admin.Controllers
{
    ...
    public class PagesController : Controller
    {
        ...
        public async Task<IActionResult> Create(Page page)
        {
            if (ModelState.IsValid)
            {
                ...
                if(slug != null)
                {
                    ModelState.AddModelError("", "Такое название уже существует");
                    return View(page);
                }
                context.Add(page);
                await context.SaveChangesAsync();
                TempData["Success"] = "Страница успешно создана";
        ...
        public async Task<IActionResult> Edit(Page page)
        {
            if (ModelState.IsValid)
            {
                ...
                context.Update(page);
                await context.SaveChangesAsync();
                TempData["Success"] = "Страница успешно отредактирована";
        ...
        public async Task<IActionResult> Delete(int id)
        {
            ...
            else
            {
                ...
                TempData["Success"] = "Страница успешно удалена";
            }
            return RedirectToAction("Index");
        }
